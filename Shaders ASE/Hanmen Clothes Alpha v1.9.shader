...
Shader "Hanmen/Clothes True Alpha"
{
	Properties
	{
		...
		[Header(Detail)]_DetailNormalMapScale("DetailNormalMapScale", Range( 0 , 9)) = 9
		_DetailNormalMapScale2("DetailNormalMapScale2", Range( 0 , 10)) = 9
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardCustom o )
		{
			...
			float4 tex2DNode1035 = SAMPLE_TEXTURE2D( _WeatheringMap, sampler_WeatheringMap, WeatheringUV907 );
			float3 appendResult1043 = (float3(1.0 , 0.0 , ( ( SAMPLE_TEXTURE2D( _WeatheringMap, sampler_WeatheringMap, appendResult1033 ).b - tex2DNode1035.b ) * _WeatheringBumpPower )));
			float2 appendResult1034 = (float2(break1030.x , ( break1030.y + temp_output_1029_0 )));
			float3 appendResult1044 = (float3(0.0 , 1.0 , ( ( SAMPLE_TEXTURE2D( _WeatheringMap, sampler_WeatheringMap, appendResult1034 ).b - tex2DNode1035.b ) * _WeatheringBumpPower )));
			...
			float4 tex2DNode916 = SAMPLE_TEXTURE2D( _WeatheringMap, sampler_WeatheringMap, WeatheringUV907 );
			...
			float3 lerpResult1052 = lerp( BlendNormals( BlendNormals( UnpackScaleNormal( SAMPLE_TEXTURE2D( _BumpMap, sampler_BumpMap, uv_BumpMap1179 ), ( _Float0 + ( WetBumpOffset1348 * ExGloss1337 ) ) ) , DetailNormal1836 ) , DetailNormal2837 ) , WeatheringBump1047 , ( SAMPLE_TEXTURE2D( _WeatheringMap, sampler_WeatheringMap, WeatheringUV907 ).b * WeatheringAlpha932 ));
			float3 normalizeResult1469 = normalize( lerpResult1052 );
			float3 switchResult1472 = (((i.ASEVFace>0)?(normalizeResult1469):(-normalizeResult1469)));
			float3 NormalMix496 = switchResult1472;
			o.Normal = NormalMix496;
			float2 uv_MainTex1185 = i.uv_texcoord;
			float3 temp_output_658_0 = (SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, uv_MainTex1185 )).rgb;
			...
			float WetSplats1353 = SAMPLE_TEXTURE2D( _WetnessMap, sampler_MainTex, uv_TexCoord1342 ).b;
			...
			float4 tex2DNode1398 = SAMPLE_TEXTURE2D( _OcclusionMap, sampler_OcclusionMap, uv_OcclusionMap1398 );
			...
			float Detail11432 = SAMPLE_TEXTURE2D( _DetailGlossMap, sampler_trilinear_repeat, Detail1UV785 ).r;
			float Detail21433 = SAMPLE_TEXTURE2D( _DetailGlossMap2, sampler_trilinear_repeat, Detail2UV786 ).r;
			...
			float lerpResult457 = lerp( 1.0 , Detail11432 , ( _DetailOcculusionScale * DetailMask1366 ));
			float lerpResult462 = lerp( 1.0 , Detail21433 , ( _DetailOcculusionScale2 * DetailMask2367 ));
			float OcclusionMix553 = saturate( ( lerpResult519 * lerpResult457 * lerpResult462 ) );
			o.Occlusion = OcclusionMix553;
			float Thickness1482 = tex2DNode15.b;
			float3 temp_cast_1 = (( ( _Translucency / 10.0 ) * Thickness1482 )).xxx;
			o.Translucency = temp_cast_1;
			float2 uv_MainTex1 = i.uv_texcoord;
			float AlphaInput426 = SAMPLE_TEXTURE2D( _MainTex, sampler_MainTex, uv_MainTex1 ).a;
...
/*ASEBEGIN
Version=18912
60.8;138.8;1230;700;3433.713;-1184.382;1.851647;True;False
...
Node;AmplifyShaderEditor.CommentaryNode;329;-3165.211,2761.059;Inherit;False;3235.085;1139.023;Comment;32;755;751;745;752;757;749;754;758;733;742;369;750;743;222;748;756;741;744;747;753;785;746;234;233;235;327;240;836;1280;1414;1415;1478;Detail Normal Map 1;1,0,0,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;330;-3159.167,4119.344;Inherit;False;3206.373;1317.682;Comment;32;778;777;776;775;774;773;771;734;772;231;769;770;768;370;767;766;765;764;763;762;761;786;237;236;238;326;251;837;1281;1416;1417;1479;Detail Normal Map 2;0.03088689,1,0,1;0;0
Node;AmplifyShaderEditor.GetLocalVarNode;1415;-2947.761,3086.752;Inherit;False;1413;UVScale;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.Vector2Node;327;-2952.363,2934.555;Inherit;False;Property;_DetailUV;DetailUV;37;0;Create;True;0;0;0;True;0;False;1,1;32,32;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;469;-5912.037,-3134.209;Inherit;False;Property;_WeatheringAll;WeatheringAll;50;0;Create;True;0;0;0;True;2;Header (Weathering);;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;326;-3144.224,4264.72;Inherit;False;Property;_DetailUV2;DetailUV2;38;0;Create;True;0;0;0;True;0;False;1,1;32,16;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.GetLocalVarNode;1417;-3141.659,4413.371;Inherit;False;1413;UVScale;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;240;-2797.419,3208.612;Inherit;False;Property;_DetailUVRotator;DetailUVRotator;35;0;Create;True;0;0;0;True;0;False;0;0;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;470;-5917.989,-4023.543;Inherit;False;Property;_WeatheringRange1;WeatheringRange1;51;0;Create;True;0;0;0;True;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;251;-3006.258,4567.135;Inherit;False;Property;_DetailUV2Rotator;DetailUV2Rotator;36;0;Create;True;0;0;0;True;0;False;0;0;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;471;-5912.647,-3855.196;Inherit;False;Property;_WeatheringRange2;WeatheringRange2;52;0;Create;True;0;0;0;True;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1164;-5913.251,-3006.681;Inherit;False;Constant;_Float3;Float 3;61;0;Create;True;0;0;0;False;0;False;0.3;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;473;-5906.739,-3492.329;Inherit;False;Property;_WeatheringRange4;WeatheringRange4;54;0;Create;True;0;0;0;True;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.CeilOpNode;1080;-4203.304,-3119.612;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;474;-5913.521,-3308.836;Inherit;False;Property;_WeatheringRange5;WeatheringRange5;55;0;Create;True;0;0;0;True;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;472;-5912.544,-3694.043;Inherit;False;Property;_WeatheringRange3;WeatheringRange3;53;0;Create;True;0;0;0;True;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.PowerNode;746;-2221.043,3635.467;Inherit;False;False;2;0;FLOAT;0.25;False;1;FLOAT;2;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1026;-5932.651,109.4873;Inherit;False;Property;_WeatheringBump;WeatheringBump;57;0;Create;True;0;0;0;True;0;False;0.4;0.4;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.ScaleNode;747;-2039.256,3644.093;Inherit;False;0.1;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerStateNode;1477;-5506.977,775.5133;Inherit;False;0;0;0;2;-1;1;0;SAMPLER2D;;False;1;SAMPLERSTATE;0
...
Node;AmplifyShaderEditor.PowerNode;761;-2300.184,5051.585;Inherit;False;False;2;0;FLOAT;0.25;False;1;FLOAT;2;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;1476;-5247.339,797.7679;Inherit;False;samplerDetail;-1;True;1;0;SAMPLERSTATE;;False;1;SAMPLERSTATE;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;1478;-1793.303,3112.05;Inherit;False;1476;samplerDetail;1;0;OBJECT;;False;1;SAMPLERSTATE;0
...
Node;AmplifyShaderEditor.RangedFloatNode;222;-3015.568,3615.209;Inherit;False;Property;_DetailNormalMapScale;DetailNormalMapScale;27;1;[Header];Create;True;1;Detail;0;0;True;0;False;9;1.73;0;9;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;1479;-1861.639,4571.598;Inherit;False;1476;samplerDetail;1;0;OBJECT;;False;1;SAMPLERSTATE;0
...
Node;AmplifyShaderEditor.RangedFloatNode;231;-3031.486,5104.057;Inherit;False;Property;_DetailNormalMapScale2;DetailNormalMapScale2;28;0;Create;True;0;0;0;True;0;False;9;1;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;
0;Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;829;-2977.513,-2267.672;Inherit;False;Property;_Roughness;Roughness;44;0;Create;True;0;0;0;False;2;Header (Metallic Roughness (Optional));;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerStateNode;1487;-3227.556,-1685.413;Inherit;False;0;0;0;1;1;1;0;SAMPLER2D;;False;1;SAMPLERSTATE;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1346;-5440.708,-5097.443;Inherit;False;Property;_WetSplatsAlbedoOffset;WetSplatsAlbedoOffset;67;0;Create;True;0;0;0;True;0;False;0.6;0.6;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;1432;-2169.868,1433.003;Inherit;False;Detail1;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerStateNode;1486;-5931.338,-5747.73;Inherit;False;0;0;0;1;1;1;0;SAMPLER2D;;False;1;SAMPLERSTATE;0
Node;AmplifyShaderEditor.PowerNode;1457;-2181.021,-6478.848;Inherit;True;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;1339;-6087.273,-4932.778;Inherit;False;Property;_BodyColor;BodyColor;63;0;Create;True;0;0;0;True;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;653;-2962.701,-949.0263;Inherit;False;Property;_Metallic4;Metallic4;48;0;Create;True;0;0;0;True;0;False;1;0.881;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1356;-6093.501,-5357.187;Inherit;False;Property;_WetOpacitySplats;WetOpacitySplats;70;0;Create;True;0;0;0;True;0;False;0;0;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;189;-2978.64,-1996.283;Inherit;False;Property;_Glossiness4;Glossiness4;46;0;Create;True;0;0;0;False;2;Header (Color 4 Settings (Optional));;False;1;0.792;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;87;-2920.6,-234.0993;Float;False;Property;_EmissionStrength;EmissionStrength;39;0;Create;True;0;0;0;True;1;Header (Emission (Tex Required));False;0;0;0;20;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1331;-1867.334,-6361.684;Inherit;False;Property;_AlphaMaster;AlphaMaster;80;0;Create;True;0;0;0;True;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;1433;-2364.838,1972.544;Inherit;False;Detail2;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1409;-6096.943,-5260.392;Inherit;False;Property;_WetGlossSplats;WetGlossSplats;66;0;Create;True;0;0;0;True;0;False;0;0;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1350;-6105.692,-5155.981;Inherit;False;Property;_WetGlossBase;WetGlossBase;65;0;Create;True;0;0;0;True;0;False;0.8;0.8;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;1389;-1351.185,-3230.595;Inherit;False;Property;_WetColor;WetColor;68;0;Create;True;0;0;0;True;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;830;-2960.85,-1250.992;Inherit;False;Property;_MetallicMask;MetallicMask;45;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;646;-2962.816,-1071.799;Inherit;False;Property;_MetallicMask4;MetallicMask4;49;0;Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1441;-1425.538,-899.4209;Inherit;False;Property;_DetailMetallicScale2;DetailMetallicScale2;32;0;Create;True;0;0;0;True;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;54;-2701.678,1612.117;Inherit;False;Property;_DetailOcculusionScale;DetailOcculusionScale;33;0;Create;True;0;0;0;False;0;False;0;0.531;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;55;-2719.32,2171.11;Inherit;False;Property;_DetailOcculusionScale2;DetailOcculusionScale2;34;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1490;-2261.621,1682.475;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;564;-2242.818,-491.0992;Inherit;False;Property;_EmissionColor3;Color3 is Emissive;42;0;Create;False;0;0;0;True;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;True;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;552;-2104.483,2114.977;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;70;-2719.177,1142.393;Inherit;False;Property;_OcculusionStrength;OcculusionStrength;43;0;Create;True;0;0;0;False;1;Header (Ambient Occlusion);False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1131;22.26852,-2122.862;Inherit;False;Property;_WeatheringGloss;WeatheringGloss;56;0;Create;True;0;0;0;True;0;False;0.8;0.8;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;519;-1769.609,937.813;Inherit;False;3;0;FLOAT;1;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;609;-1964.979,-490.4353;Inherit;False;Property;_EmissionColor2;Color2 is Emissive;41;0;Create;False;0;0;0;True;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;True;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.LerpOp;457;-1882.785,1418.206;Inherit;False;3;0;FLOAT;1;False;1;FLOAT;1;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1459;-97.41052,-6094.526;Inherit;False;Property;_Cutoff;Cutoff;81;0;Create;True;0;0;0;True;0;False;0.01;0.01;0.01;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1481;-1196.107,946.0737;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;610;-1673.733,-492.9193;Inherit;False;Property;_EmissionColor1;Color1 is Emissive;40;0;Create;False;0;0;0;True;1;Header (Color Mask Required (Optional));False;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;True;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1468;1367.876,-1279.679;Inherit;False;Property;_Translucency;Translucency;79;1;[HideInInspector];Fetch;True;0;0;0;True;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;1482;-2445.015,-1606.197;Inherit;False;Thickness;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;1485;-740.7373,946.7815;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1471;1638.364,-1153.163;Inherit;False;Constant;_Float2;Float 2;83;0;Create;True;0;0;0;False;0;False;10;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleDivideOpNode;1470;1819.365,-1276.163;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;553;-300.0333,939.8786;Inherit;False;OcclusionMix;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;1484;1618.669,-1055.599;Inherit;False;1482;Thickness;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1483;1987.669,-1274.599;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;779;-4828.919,951.074;Inherit;True;Property;_DetailGlossMap2;DetailGlossMap2;7;1;[NoScaleOffset];Create;True;0;0;0;True;2;Header (Detail2);;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;1463;-5353.528,1173.008;Inherit;False;Property;_BlendDST;BlendDST;83;1;[IntRange];Create;True;0;0;0;True;0;False;11;11;1;11;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;515;1905.196,-1810.923;Inherit;False;501;DiffuseMix;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;499;1518.627,-2071.901;Inherit;False;496;NormalMix;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1464;-5353.039,969.4247;Inherit;False;Property;_AlphaToMask;AlphaToMask;84;1;[Toggle];Create;True;0;0;0;True;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1284;1357.351,-1148.336;Inherit;False;Property;_CullMode;CullMode;0;1;[IntRange];Create;True;0;3;None;0;Front;1;Back;2;0;True;1;Header (0 none 1 front 2 back);False;0;0;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1462;-5353.51,1080.842;Inherit;False;Property;_BlendSCR;BlendSCR;82;1;[IntRange];Create;True;0;0;0;True;0;False;5;5;1;11;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;2445.23,-1771.036;Float;False;True;-1;7;ASEMaterialInspector;0;0;Standard;Hanmen/Clothes True Alpha;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;False;Off;2;False;-1;3;False;-1;False;-2.6;False;-1;1;False;-1;False;7;Custom;0.01;True;True;0;True;Transparent;2600;Transparent;ForwardOnly;6;d3d9;d3d11_9x;d3d11;glcore;gles;gles3;True;True;True;True;0;False;-1;False;255;False;-1;255;False;-1;255;False;-1;4;False;-1;0;False;-1;0;False;-1;0;False;-1;3;False;-1;0;False;-1;0;False;-1;3;False;-1;False;0;32;1;2;True;1;True;2;5;True;1462;10;True;1463;0;0;False;1466;0;False;1465;0;False;-1;0;False;1464;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;72;-1;-1;0;False;0;0;True;1284;-1;0;False;1459;0;0;0;False;0.1;False;-1;0;True;1464;True;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;1490;0;54;0
WireConnection;1490;1;442;0
...
WireConnection;462;1;1433;0
WireConnection;462;2;552;0
WireConnection;457;1;1432;0
WireConnection;457;2;1490;0
...
WireConnection;1481;0;519;0
WireConnection;1481;1;457;0
WireConnection;1481;2;462;0
...
WireConnection;1482;0;15;3
WireConnection;88;0;394;0
WireConnection;88;1;610;0
WireConnection;1485;0;1481;0
...
WireConnection;1483;0;1470;0
WireConnection;1483;1;1484;0
...
WireConnection;779;7;1476;0
WireConnection;867;0;866;0
WireConnection;867;1;865;0
WireConnection;760;7;1476;0
...
WireConnection;0;7;1483;0
WireConnection;0;9;491;0
ASEEND*/
//CHKSM=573BC9020708F65BA8A09F578B03514B94031490
