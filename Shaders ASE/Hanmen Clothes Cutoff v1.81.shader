...
Shader "Hanmen/Clothes True Cutoff"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardCustom o )
		{
			...
			float4 tex2DNode743 = SAMPLE_TEXTURE2D( _DetailGlossMap, sampler_DetailGlossMap, Detail1UV785 );
			...
			float3 appendResult745 = (float3(1.0 , 0.0 , ( ( SAMPLE_TEXTURE2D( _DetailGlossMap, sampler_DetailGlossMap, appendResult756 ).g - tex2DNode743.g ) * temp_output_733_0 )));
			float2 appendResult748 = (float2(break753.x , ( break753.y + temp_output_747_0 )));
			float3 appendResult752 = (float3(0.0 , 1.0 , ( ( SAMPLE_TEXTURE2D( _DetailGlossMap, sampler_DetailGlossMap, appendResult748 ).g - tex2DNode743.g ) * temp_output_733_0 )));
			...
			float4 tex2DNode770 = SAMPLE_TEXTURE2D( _DetailGlossMap2, sampler_DetailGlossMap2, Detail2UV786 );
			float DetailMask2367 = tex2DNode1182.g;
			float temp_output_734_0 = ( DetailMask2367 * -( _DetailNormalMapScale2 / 10.0 ) );
			float3 appendResult776 = (float3(1.0 , 0.0 , ( ( SAMPLE_TEXTURE2D( _DetailGlossMap2, sampler_DetailGlossMap2, appendResult767 ).g - tex2DNode770.g ) * temp_output_734_0 )));
			float2 appendResult766 = (float2(break763.x , ( break763.y + temp_output_762_0 )));
			float3 appendResult775 = (float3(0.0 , 1.0 , ( ( SAMPLE_TEXTURE2D( _DetailGlossMap2, sampler_DetailGlossMap2, appendResult766 ).g - tex2DNode770.g ) * temp_output_734_0 )));
			float3 normalizeResult778 = normalize( cross( appendResult776 , appendResult775 ) );
			float3 DetailNormal2837 = normalizeResult778;
			float3 temp_output_374_0 = BlendNormals( BlendNormals( UnpackScaleNormal( SAMPLE_TEXTURE2D( _BumpMap, sampler_BumpMap, uv_BumpMap1179 ), ( _BumpScale + ( WetBumpOffset1264 * ExGloss877 ) ) ) , DetailNormal1836 ) , DetailNormal2837 );
			...
			float WetSplats1243 = SAMPLE_TEXTURE2D( _WetnessMap, sampler_WetnessMap, uv_TexCoord1246 ).b;
			...
			float4 tex2DNode343 = SAMPLE_TEXTURE2D( _DetailMainTex, sampler_DetailMainTex, uv_DetailMainTex343 );
			...
			float4 tex2DNode780 = SAMPLE_TEXTURE2D( _DetailGlossMap, sampler_DetailGlossMap, Detail1UV785 );
			float Detail11308 = tex2DNode780.r;
			float4 tex2DNode781 = SAMPLE_TEXTURE2D( _DetailGlossMap2, sampler_DetailGlossMap2, Detail2UV786 );
			...
			float dither1350 = DitherNoiseTex(ase_screenPosNorm, _Noise, sampler_Noise, _Noise_TexelSize);
...
/*ASEBEGIN
Version=18912
6;6;1358;878;5401.49;-879.1636;1.3;True;False
...
Node;AmplifyShaderEditor.CommentaryNode;329;-3165.211,2761.059;Inherit;False;3235.085;1139.023;Comment;33;755;751;745;752;757;749;754;758;733;742;369;750;743;222;748;756;741;744;747;753;785;746;234;233;235;327;240;836;1300;1301;1303;1336;1476;Detail Normal Map 1;1,0,0,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;330;-3159.167,4119.344;Inherit;False;3206.373;1317.682;Comment;33;778;777;776;775;774;773;771;734;772;231;769;770;768;370;767;766;765;764;763;762;761;786;237;236;238;326;251;837;1299;1304;1305;1337;1475;Detail Normal Map 2;0.03088689,1,0,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;231;-3056.468,5144.184;Inherit;False;Property;_DetailNormalMapScale2;DetailNormalMapScale2;36;0;Create;True;0;0;0;True;0;False;1;1;-3;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleDivideOpNode;1336;-2768.841,3574.498;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;10;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleDivideOpNode;1337;-2741.195,5147.701;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;10;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.NegateNode;1476;-2606.509,3576.454;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1432;3889.965,1594.585;Inherit;False;Property;_DitherBlueNoise;DitherBlueNoise;79;1;[Enum];Create;True;0;0;0;True;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;1427;818.9415,1814.427;Inherit;True;Property;_Noise;Noise;78;0;Create;True;0;0;0;True;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;1468;2938.857,-985.145;Inherit;False;Property;_Translucency;Translucency;77;0;Fetch;True;0;0;0;True;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;660;1638.194,1923.225;Inherit;False;Property;_Cutoff;Cutoff;31;0;Create;True;0;0;0;True;1;Header (Zero Disable Dithering);False;0;0.01;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerStateNode;1472;-4655.077,1685.763;Inherit;False;0;0;0;1;1;1;0;SAMPLER2D;;False;1;SAMPLERSTATE;0
...
Node;AmplifyShaderEditor.SamplerStateNode;1477;-4949.095,1692.964;Inherit;False;0;0;0;1;1;1;0;SAMPLER2D;;False;1;SAMPLERSTATE;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;3587.755,-1271.375;Float;False;True;-1;7;ASEMaterialInspector;0;0;Standard;Hanmen/Clothes True Cutoff;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;False;Off;1;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Masked;0.01;True;True;0;False;TransparentCutout;2450;AlphaTest;ForwardOnly;6;d3d9;d3d11_9x;d3d11;glcore;gles;gles3;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;0;32;1;2;True;1;True;0;1;False;-1;10;False;-1;1;5;False;-1;8;False;-1;6;False;-1;6;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;Legacy Shaders/Diffuse;-1;0;-1;-1;0;False;0;0;True;1210;-1;0;True;660;0;0;0;False;0.1;False;-1;0;False;-1;True;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=D8BC494B297325A326EC7A725C5262E52027C299
