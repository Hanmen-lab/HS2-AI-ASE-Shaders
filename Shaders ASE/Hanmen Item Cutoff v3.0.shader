	...
	LOD 0
		...
		uniform float _Cutoff;
			...
			float4 frag (v2f i , FRONT_FACE_TYPE ase_vface : FRONT_FACE_SEMANTIC) : SV_Target
			{
				...
				float3 lightDir14_g278 = worldSpaceLightDir;
				float3 viewDir15_g278 = ase_worldViewDir;
				float3 normalizeResult136_g278 = ASESafeNormalize( ( lightDir14_g278 + viewDir15_g278 ) );
				float dotResult137_g278 = dot( lightDir14_g278 , normalizeResult136_g278 );
				float LdotH139_g278 = saturate( dotResult137_g278 );
				...
				float smoothness169_g278 = OutSmoothness1458;
				float perceprualRoughness188_g278 = ( 1.0 - smoothness169_g278 );
				half fd90273_g278 = ( 0.5 + ( 2.0 * LdotH139_g278 * LdotH139_g278 * perceprualRoughness188_g278 ) );
				float3 OutNormal1457 = temp_output_1549_342;
				float3 tanNormal29_g278 = OutNormal1457;
				float3 worldNormal29_g278 = float3(dot(tanToWorld0,tanNormal29_g278), dot(tanToWorld1,tanNormal29_g278), dot(tanToWorld2,tanNormal29_g278));
				float3 normalizeResult25_g278 = normalize( worldNormal29_g278 );
				float3 switchResult316_g278 = (((ase_vface>0)?(normalizeResult25_g278):(-normalizeResult25_g278)));
				float3 normalDir28_g278 = ( _NormalBackDirInvert == 1.0 ? switchResult316_g278 : normalizeResult25_g278 );
				float dotResult21_g278 = dot( lightDir14_g278 , normalDir28_g278 );
				float NdotL20_g278 = saturate( dotResult21_g278 );
				half lightScatter253_g278 = ( ( ( fd90273_g278 - 1.0 ) * pow( ( 1.0 - NdotL20_g278 ) , 5.0 ) ) + 1.0 );
				float dotResult56_g278 = dot( normalDir28_g278 , viewDir15_g278 );
				float NdotV55_g278 = saturate( dotResult56_g278 );
				half viewScatter254_g278 = ( 1.0 + ( pow( ( 1.0 - NdotV55_g278 ) , 5.0 ) * ( fd90273_g278 - 1.0 ) ) );
				half disneydiffuse251_g278 = ( lightScatter253_g278 * viewScatter254_g278 );
				half Diffuseterm281_g278 = ( disneydiffuse251_g278 * NdotL20_g278 );
				...
				float3 lightAtten296_g278 = ( ase_lightColor.rgb * ase_atten );
				UnityGIInput data203_g278;
				UNITY_INITIALIZE_OUTPUT( UnityGIInput, data203_g278 );
				#if defined(LIGHTMAP_ON) || defined(DYNAMICLIGHTMAP_ON) //dylm203_g278
				data203_g278.lightmapUV = i.ase_lmap;
				#endif //dylm203_g278
				#if UNITY_SHOULD_SAMPLE_SH //fsh203_g278
				data203_g278.ambient = i.ase_sh;
				#endif //fsh203_g278
				UnityGI gi203_g278 = UnityGI_Base(data203_g278, 1, normalDir28_g278);
				...
				float occlusion306_g278 = OutAO1462;
				half Roughness64_g278 = max( ( perceprualRoughness188_g278 * perceprualRoughness188_g278 ) , 0.002 );
				half SmithJointGGXVisibilityTerm42_g278 = ( 0.5 / ( ( ( ( NdotV55_g278 * ( 1.0 - Roughness64_g278 ) ) + Roughness64_g278 ) * NdotL20_g278 ) + 1E-05 + ( NdotV55_g278 * ( Roughness64_g278 + ( ( 1.0 - Roughness64_g278 ) * NdotL20_g278 ) ) ) ) );
				float a266_g278 = ( Roughness64_g278 * Roughness64_g278 );
				float3 normalizeResult87_g278 = ASESafeNormalize( ( lightDir14_g278 + viewDir15_g278 ) );
				float dotResult88_g278 = dot( normalDir28_g278 , normalizeResult87_g278 );
				float NdotH90_g278 = saturate( dotResult88_g278 );
				float d99_g278 = ( ( ( ( NdotH90_g278 * a266_g278 ) - NdotH90_g278 ) * NdotH90_g278 ) + 1.0 );
				half GGXTerm43_g278 = ( ( ( 1.0 / UNITY_PI ) * a266_g278 ) / ( ( d99_g278 * d99_g278 ) + 1E-07 ) );
				float temp_output_36_0_g278 = ( SmithJointGGXVisibilityTerm42_g278 * GGXTerm43_g278 * UNITY_PI );
				#ifdef UNITY_COLORSPACE_GAMMA
				float staticSwitch5_g278 = sqrt( max( 0.0001 , temp_output_36_0_g278 ) );
				#else
				float staticSwitch5_g278 = temp_output_36_0_g278;
				#endif
				#ifdef _SPECULARHIGHLIGHTS_OFF
				float staticSwitch119_g278 = 0.0;
				#else
				float staticSwitch119_g278 = max( 0.0 , ( staticSwitch5_g278 * NdotL20_g278 ) );
				#endif
				#ifdef _IRIDISCENT_ON
				...
				float3 SpecColor140_g278 = ( OutSpecular1456 * occlusion306_g278 );
				float SpecularTerm34_g278 = ( staticSwitch119_g278 * ( SpecColor140_g278.x == float3( 0,0,0 ) ? 0.0 : 1.0 ) );
				half3 FresnelTerm130_g278 = ( ( pow( ( 1.0 - LdotH139_g278 ) , 5.0 ) * ( 1.0 - SpecColor140_g278 ) ) + SpecColor140_g278 );
				half metallic176_g278 = 0.0;
				half localOneMinusReflectivity176_g278 = OneMinusReflectivity( metallic176_g278 );
				half GrazingTerm163_g278 = saturate( ( smoothness169_g278 + ( 1.0 - localOneMinusReflectivity176_g278 ) ) );
				float3 temp_cast_3 = (GrazingTerm163_g278).xxx;
				float3 lerpResult159_g278 = lerp( SpecColor140_g278 , temp_cast_3 , pow( ( 1.0 - NdotV55_g278 ) , 5.0 ));
				half3 FresnelLerp165_g278 = lerpResult159_g278;
				#ifdef UNITY_COLORSPACE_GAMMA
				float staticSwitch183_g278 = ( 1.0 - ( 0.28 * Roughness64_g278 * perceprualRoughness188_g278 ) );
				#else
				float staticSwitch183_g278 = ( 1.0 / ( ( Roughness64_g278 * Roughness64_g278 ) + 1.0 ) );
				#endif
				half SurfaceReduction182_g278 = staticSwitch183_g278;
				UnityGIInput data;
				...
				#endif //specdataif1
				Unity_GlossyEnvironmentData g299_g278 = UnityGlossyEnvironmentSetup( smoothness169_g278, ase_worldViewDir, normalDir28_g278, float3(0,0,0));
				float3 indirectSpecular299_g278 = UnityGI_IndirectSpecular( data, occlusion306_g278, normalDir28_g278, g299_g278 );
				#ifdef _ENVIRONMENTREFLECTIONS_OFF
				float3 staticSwitch313_g278 = float3( 0,0,0 );
				#else
				float3 staticSwitch313_g278 = ( FresnelLerp165_g278 * SurfaceReduction182_g278 * indirectSpecular299_g278 );
				#endif
				#ifdef UNITY_PASS_FORWARDADD
				float3 staticSwitch305_g278 = float3( 0,0,0 );
				#else
				float3 staticSwitch305_g278 = staticSwitch313_g278;
				#endif
				...
				float3 tanNormal14_g277 = OutNormal1457;
				float3 worldNormal14_g277 = float3(dot(tanToWorld0,tanNormal14_g277), dot(tanToWorld1,tanNormal14_g277), dot(tanToWorld2,tanNormal14_g277));
				float3 normalizeResult29_g277 = normalize( worldNormal14_g277 );
				float3 switchResult32_g277 = (((ase_vface>0)?(normalizeResult29_g277):(-normalizeResult29_g277)));
				float dotResult9_g277 = dot( ( _NormalBackDirInvert == 1.0 ? switchResult32_g277 : normalizeResult29_g277 ) , worldSpaceLightDir );
				#ifdef _TRANSMISSION_ON
				float3 staticSwitch36_g277 = ( ( max( 0.0 , -dotResult9_g277 ) * ( ase_lightColor.rgb * ase_atten ) * _TransmissionStrength ) * OutAlbedo1461 );
				#else
				float3 staticSwitch36_g277 = float3( 0,0,0 );
				#endif
				...
				outColor = ( ( ( OutAlbedo1461 * ( ( Diffuseterm281_g278 * lightAtten296_g278 ) + ( gi203_g278.indirect.diffuse * occlusion306_g278 ) ) ) + ( SpecularTerm34_g278 * lightAtten296_g278 * FresnelTerm130_g278 ) + staticSwitch305_g278 ) + OutEmission1463 + ( ( ( pow( saturate( dotResult20_g279 ) , _TransScattering ) * _TransDirect ) * temp_output_59_0_g279 * lerpResult39_g279 * temp_output_6_0_g279 ) + saturate( ( ( gi15_g279.indirect.diffuse * _TransAmbient ) * temp_output_59_0_g279 * temp_output_6_0_g279 * temp_output_74_0_g279 ) ) ) + staticSwitch36_g277 );
				outAlpha = OutOp1464;
		...
		Pass
		{
			...
			void frag (v2f i , FRONT_FACE_TYPE ase_vface : FRONT_FACE_SEMANTIC, out half4 outGBuffer0 : SV_Target0, out half4 outGBuffer1 : SV_Target1, out half4 outGBuffer2 : SV_Target2, out half4 outGBuffer3 : SV_Target3)
			{
				...
				float OcclusionMix323_g271 = saturate( ( lerpResult298_g271 * lerpResult297_g271 * lerpResult299_g271 ) );
				float OutAO1462 = OcclusionMix323_g271;
				float4 appendResult2_g285 = (float4(temp_output_3_0_g285 , OutAO1462));
				...
				float EmissionMask384_g271 = tex2DNode139_g271.g;
				float3 OutEmission1463 = ( (_EmissionColor).rgb * _EmissionStrength * Maintex365_g271 * EmissionMask384_g271 );
				float3 tanNormal27_g283 = OutNormal1457;
				float3 worldNormal27_g283 = float3(dot(tanToWorld0,tanNormal27_g283), dot(tanToWorld1,tanNormal27_g283), dot(tanToWorld2,tanNormal27_g283));
				float3 normalizeResult61_g283 = normalize( worldNormal27_g283 );
				float3 switchResult64_g283 = (((ase_vface>0)?(normalizeResult61_g283):(-normalizeResult61_g283)));
				float3 normal2_g284 = ( _NormalBackDirInvert == 1.0 ? switchResult64_g283 : normalizeResult61_g283 );
				float3 localGI2_g284 = GI2_g284( normal2_g284 );
				float temp_output_59_0_g283 = ( _Translucency * 1.0 );
				float3 Diffuse1553 = temp_output_1549_345;
				float3 temp_output_6_0_g283 = Diffuse1553;
				float temp_output_74_0_g283 = OutAO1462;
				float3 normal2_g286 = temp_output_22_0_g285;
				float3 localGI2_g286 = GI2_g286( normal2_g286 );
				#ifdef UNITY_HDR_ON
				float3 staticSwitch16_g285 = ( ( OutEmission1463 + saturate( ( ( localGI2_g284 * _TransAmbient ) * temp_output_59_0_g283 * temp_output_6_0_g283 * temp_output_74_0_g283 ) ) ) + ( temp_output_3_0_g285 * localGI2_g286 ) );
				#else
				float3 staticSwitch16_g285 = exp2( -( ( OutEmission1463 + saturate( ( ( localGI2_g284 * _TransAmbient ) * temp_output_59_0_g283 * temp_output_6_0_g283 * temp_output_74_0_g283 ) ) ) + ( temp_output_3_0_g285 * localGI2_g286 ) ) );
				#endif
...
/*ASEBEGIN
Version=18912
243.6;169.6;1524;884;7036.379;3477.2;3.575814;True;False
...
Node;AmplifyShaderEditor.FunctionNode;1424;-4102.147,-2525.21;Inherit;False;Unity Translucency;63;;279;3081dbcb6ac8af842b2faa561ed4ff52;0;4;74;FLOAT;0;False;6;FLOAT3;0,0,0;False;26;FLOAT3;0,0,1;False;46;FLOAT;1;False;2;FLOAT3;0;FLOAT3;68
...
Node;AmplifyShaderEditor.FunctionNode;1548;-3996.01,-2771.343;Inherit;False;GGX Specular Light;1;;278;53564f0ffa5fbe14e85233656c8e0b13;0;5;286;FLOAT3;0,0,0;False;30;FLOAT3;0,0,0;False;146;FLOAT3;0,0,0;False;147;FLOAT;0;False;302;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode;1547;-3985.645,-2385.598;Inherit;False;Unity Transmission;72;;277;9498cceedd4defe45a721369ca43b3c7;0;2;1;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;1550;-4634.047,-1597.457;Inherit;False;Unity Translucency;63;;283;3081dbcb6ac8af842b2faa561ed4ff52;0;4;74;FLOAT;0;False;6;FLOAT3;0,0,0;False;26;FLOAT3;0,0,1;False;46;FLOAT;1;False;2;FLOAT3;0;FLOAT3;68
...
ASEEND*/
//CHKSM=9745C7F4801B9144A5E0539420338981DCB38002