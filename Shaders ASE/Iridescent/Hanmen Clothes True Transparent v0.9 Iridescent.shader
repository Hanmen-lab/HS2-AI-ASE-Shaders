...
Shader "Iridescent/Clothes True Transparent"
{
	Properties
	{
		...
		_WetnessPower2("WetnessPower2", Range( 0 , 2)) = 0.25
		...
		[Toggle(_DETAILGLOSS_ON)] _DetailGloss("DetailGloss", Float) = 0
		...
		[Header (Alpha masking Occlusion_A Mask (Optional))][Toggle(_ALPHAMASK_ON)] _AlphaMask("AlphaMask", Float) = 0
		_IriSaturation("IriSaturation", Range( 0 , 1)) = 0.5688156
		_IriBrightness("IriBrightness", Range( 0 , 1)) = 0.6471324
		_DetailAlpha2("DetailAlpha2", Range( 0 , 2)) = 1
		_IriContrast("IriContrast", Range( 0 , 1)) = 0.5840003
		_DetailAlpha1("DetailAlpha1", Range( 0 , 2)) = 1
		_AlphaMaskOpacity("AlphaMaskOpacity", Range( 0 , 2)) = 1
		...
		[Toggle(_DETAILALPHA_ON)] _DetailAlpha("DetailAlpha", Float) = 0
	...
	SubShader
	{
		...
		#pragma shader_feature _DETAILGLOSS_ON
		#pragma shader_feature _DETAILOCCLUSION_ON
		#pragma shader_feature _DETAILALPHA_ON
		#pragma shader_feature _ALPHAMASK_ON
		...
		uniform float _AlphaMaskOpacity;
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float dotResult1284 = dot( ase_tanViewDir , NormalMix496 );
			float2 temp_cast_0 = (dotResult1284).xx;
			float3 temp_output_1290_0 = (tex2D( _ColorRamp, temp_cast_0 )).rgb;
			float temp_output_1287_0 = radians( ( 360.0 * _IriHue ) );
			float temp_output_1288_0 = cos( temp_output_1287_0 );
			float3 _k2 = float3(0.57735,0.57735,0.57735);
			float dotResult1291 = dot( _k2 , temp_output_1290_0 );
			float3 temp_output_1308_0 = ( ( ( ( ( ( temp_output_1290_0 * temp_output_1288_0 ) + ( cross( _k2 , temp_output_1290_0 ) * sin( temp_output_1287_0 ) ) + ( _k2 * dotResult1291 * ( 1.0 - temp_output_1288_0 ) ) ) - float3( 0.5,0.5,0.5 ) ) * ( _IriContrast * 2.0 ) ) + float3( 0.5,0.5,0.5 ) ) + ( ( _IriBrightness * 2.0 ) - 1.0 ) );
			float dotResult1311 = dot( temp_output_1308_0 , float3(0.39,0.59,0.11) );
			float3 temp_cast_1 = (dotResult1311).xxx;
			float3 lerpResult1314 = lerp( temp_cast_1 , temp_output_1308_0 , ( _IriSaturation * 2.0 ));
			...
			float3 lerpResult1315 = lerp( DiffuseMix501 , lerpResult1314 , MetallicFinal636);
			float3 Specular1316 = lerpResult1315;
			o.Specular = Specular1316;
			float WetGloss889 = ( clampResult885 * _WetnessPower );
			float lerpResult828 = lerp( 1.0 , tex2DNode15.r , _Roughness);
			float grayscale1224 = Luminance(tex2D( _DetailGlossMap, Detail1UV785 ).rgb);
			float temp_output_1249_0 = ( grayscale1224 * DetailMask1366 );
			float grayscale1228 = Luminance(tex2D( _DetailGlossMap2, Detail2UV786 ).rgb);
			float temp_output_1250_0 = ( grayscale1228 * DetailMask2367 );
			float DetailGloss1233 = ( temp_output_1249_0 + temp_output_1250_0 );
			#ifdef _DETAILGLOSS_ON
				float staticSwitch1218 = DetailGloss1233;
			#else
				float staticSwitch1218 = lerpResult828;
			#endif
			float lerpResult534 = lerp( 1.0 , tex2DNode15.r , _Roughness4);
			float lerpResult808 = lerp( ( staticSwitch1218 * tex2DNode343.b ) , ( _Glossiness4 * lerpResult534 ) , ColorMask4377);
			...
			float lerpResult1267 = lerp( staticSwitch1210 , _AlphaMaskOpacity , AlphaMask1194);
			#ifdef _ALPHAMASK_ON
				float staticSwitch1197 = lerpResult1267;
			#else
				float staticSwitch1197 = staticSwitch1210;
			#endif
			float detail11257 = temp_output_1249_0;
			float lerpResult1196 = lerp( staticSwitch1197 , _DetailAlpha1 , detail11257);
			float detail21258 = temp_output_1250_0;
			float lerpResult1259 = lerp( lerpResult1196 , _DetailAlpha2 , detail21258);
			#ifdef _DETAILALPHA_ON
				float staticSwitch1271 = lerpResult1259;
			#else
				float staticSwitch1271 = staticSwitch1197;
			#endif
			float lerpResult1186 = lerp( staticSwitch1271 , 1.0 , ( staticSwitch1271 * WeatheringAlpha2922 ));
			...
			float AlphaMix487 = ( lerpResult701 * ceil( AlphaInput426 ) );
			o.Alpha = AlphaMix487;
		}
...
/*ASEBEGIN
Version=18301
80;1;1782;1010;-171.2148;2032.263;1;True;True
...
Node;AmplifyShaderEditor.Vector4Node;1189;-5926.035,-1197.139;Inherit;False;Property;_WeatheringUV;WeatheringUV;22;0;Create;True;0;0;True;0;False;1,1,0,0;1,1,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector2Node;327;-3062.235,2930.808;Inherit;False;Property;_DetailUV;DetailUV;18;0;Create;True;0;0;True;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;469;-5912.037,-3134.209;Inherit;False;Property;_WeatheringAll;WeatheringAll;51;0;Create;True;0;0;True;2;Header (Weathering);;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;472;-5912.544,-3694.043;Inherit;False;Property;_WeatheringRange3;WeatheringRange3;54;0;Create;True;0;0;True;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;474;-5913.521,-3308.836;Inherit;False;Property;_WeatheringRange5;WeatheringRange5;56;0;Create;True;0;0;True;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;470;-5917.989,-4023.543;Inherit;False;Property;_WeatheringRange1;WeatheringRange1;52;0;Create;True;0;0;True;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;471;-5912.647,-3855.196;Inherit;False;Property;_WeatheringRange2;WeatheringRange2;53;0;Create;True;0;0;True;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;473;-5906.739,-3492.329;Inherit;False;Property;_WeatheringRange4;WeatheringRange4;55;0;Create;True;0;0;True;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1026;-5932.651,109.4873;Inherit;False;Property;_WeatheringBump;WeatheringBump;58;0;Create;True;0;0;True;0;False;0.4;0.4;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;222;-2880.408,3504.121;Inherit;False;Property;_DetailNormalMapScale;DetailNormalMapScale;32;0;Create;True;0;0;True;0;False;1;1;-3;9;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;231;-3043.468,5020.184;Inherit;False;Property;_DetailNormalMapScale2;DetailNormalMapScale2;33;0;Create;True;0;0;True;0;False;1;1;-3;9;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;1037;-4898.854,-305.2291;Inherit;True;Property;_TextureSample19;Texture Sample 19;10;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;24;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;1035;-4906.929,-585.4694;Inherit;True;Property;_TextureSample28;Texture Sample 28;10;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;24;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;1040;-4562.014,-226.4625;Inherit;False;Property;_WeatheringBumpPower;WeatheringBumpPower;60;0;Create;True;0;0;True;0;False;2;2;0;9;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;1184;-8038.901,-2394.864;Inherit;True;Property;_TextureSample14;Texture Sample 14;12;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;831;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;44;433.2136,2942.091;Inherit;False;Property;_BumpScale;BumpScale;31;0;Create;True;0;0;True;2;Header (Bump);;False;1;1;0;3;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;728;-8028.063,-2161.204;Inherit;False;Property;_ExGloss;ExGloss;28;0;Create;True;0;0;True;1;Header (Wetness);False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;1050;1437.015,3494.834;Inherit;True;Property;_TextureSample18;Texture Sample 18;10;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;24;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.CommentaryNode;1198;-2966.524,-4611.22;Inherit;False;1671.519;808.8069;Comment;11;1209;1208;1207;1206;1205;1204;1203;1202;1201;1200;1199;Fresnel;1,1,1,1;0;0
Node;AmplifyShaderEditor.GetLocalVarNode;1201;-2884.842,-3938.579;Inherit;False;496;NormalMix;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.ViewDirInputsCoordNode;1200;-2901.315,-4138.998;Inherit;False;World;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.WorldNormalVector;1199;-2916.524,-4300.053;Inherit;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;1206;-2917.33,-4384.876;Inherit;False;Property;_FresnelPower1;FresnelPower;69;0;Create;True;0;0;False;1;Space(30);False;5;5;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1202;-2918.81,-4467.939;Inherit;False;Property;_FresnelScale1;FresnelScale;71;0;Create;True;0;0;False;0;False;5;5;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1205;-2925.819,-4555.616;Inherit;False;Property;_FresnelBias1;FresnelBias;70;0;Create;True;0;0;False;0;False;5;5;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.BlendNormalsNode;1203;-2620.83,-4118.088;Inherit;False;0;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.BlendNormalsNode;1204;-2617.756,-3962.22;Inherit;False;0;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FresnelNode;1207;-2061.021,-4298.658;Inherit;False;Standard;WorldNormal;ViewDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;1277;469.8611,4432.58;Inherit;False;1767.436;678.9692;Comment;14;1220;1219;1227;1224;1225;1226;1230;1228;1249;1250;1257;1258;1251;1233;;1,1,1,1;0;0
Node;AmplifyShaderEditor.ClampOpNode;1208;-1796.451,-4164.596;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;1278;-798.1257,-3918.886;Inherit;False;4454.023;1225.806;Comment;38;1316;1315;1314;1313;1312;1311;1310;1309;1308;1307;1306;1305;1304;1303;1302;1301;1300;1299;1298;1297;1296;1295;1294;1293;1292;1291;1290;1289;1288;1287;1286;1285;1284;1283;1282;1281;1280;1279;Iridescence;0,0.9176164,1,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;1279;-662.2804,-3364.55;Inherit;False;Property;_IriHue;IriHue;59;0;Create;True;0;0;True;1;Header (Iridescence);False;0.5064838;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ViewDirInputsCoordNode;1281;-670.6981,-3664.521;Inherit;False;Tangent;True;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.GetLocalVarNode;1280;-663.3922,-3463.053;Inherit;False;496;NormalMix;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;1209;-1581.447,-4094.871;Inherit;True;Fresnel;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;1220;519.8611,4507.688;Inherit;False;785;Detail1UV;1;0;OBJECT;;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.CommentaryNode;273;-3976.354,-5887.094;Inherit;False;3781.673;951.8832;Comment;32;1275;1274;1272;1214;487;406;701;708;731;732;1186;709;705;710;1193;1271;43;1187;1259;1196;1261;1262;1269;1247;1197;1267;1210;1239;1195;1212;1211;427;Alpha;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;201;-3016.858,-2424.756;Inherit;False;3260.911;3057.665;MetallicGlossMap;42;87;580;88;394;570;573;569;37;806;816;807;809;815;808;810;636;584;393;189;534;828;900;533;579;829;645;653;343;827;15;608;830;646;606;607;1175;1215;1216;1218;1234;1243;1244;Metallic Glossiness Emission;1,1,1,1;0;0
Node;AmplifyShaderEditor.Vector3Node;1282;-49.71667,-3227.312;Inherit;False;Constant;_k2;k;0;0;Create;True;0;0;False;0;False;0.57735,0.57735,0.57735;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.DotProductOpNode;1284;-412.2644,-3661.166;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1283;79.5076,-3380.398;Inherit;False;2;2;0;FLOAT;360;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;1211;-3634.004,-5530.277;Inherit;False;1209;Fresnel;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;427;-3917.911,-5829.634;Inherit;False;426;AlphaInput;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;1178;-2726.443,911.4077;Inherit;True;Property;_TextureSample2;Texture Sample 2;9;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;23;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;1227;525.6157,4812.337;Inherit;False;786;Detail2UV;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SamplerNode;1219;740.1376,4483.66;Inherit;True;Property;_TextureSample20;Texture Sample 20;5;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;760;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RadiansOpNode;1287;258.4315,-3377.862;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;653;-2962.701,-949.0263;Inherit;False;Property;_Metallic4;Metallic4;49;0;Create;True;0;0;True;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.WireNode;1285;271.274,-3067.087;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SamplerNode;1226;749.1806,4789.98;Inherit;True;Property;_TextureSample22;Texture Sample 22;6;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;779;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LerpOp;1212;-3415.929,-5732.455;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;1;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCGrayscale;1224;1084.278,4482.58;Inherit;False;0;1;0;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;1225;824.3703,4706.97;Inherit;False;366;DetailMask1;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;1286;-274.1711,-3687.901;Inherit;True;Property;_ColorRamp;ColorRamp;8;1;[NoScaleOffset];Create;True;0;0;True;0;False;-1;None;44e3daf259d943b4bb01b3342415dba3;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.CosOpNode;1288;527.2263,-3452.952;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ComponentMaskNode;1290;67.81204,-3686.563;Inherit;False;True;True;True;False;1;0;COLOR;0,0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.WireNode;1289;315.2432,-3028.194;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.TFHCGrayscale;1228;1081.299,4790.853;Inherit;False;0;1;0;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;646;-2962.816,-1071.799;Inherit;False;Property;_MetallicMask4;MetallicMask4;50;0;Create;True;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;1210;-3219.435,-5825.229;Inherit;False;Property;_AlphaFresnel;AlphaFresnel;68;0;Create;True;0;0;False;2;Space(30);Header (Fresnel Settings);False;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1249;1403.811,4492.161;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1239;-3230.046,-5658.345;Inherit;False;Property;_AlphaMaskOpacity;AlphaMaskOpacity;67;0;Create;True;0;0;False;0;False;1;1;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;1230;822.3005,4996.549;Inherit;False;367;DetailMask2;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;1195;-3204.183,-5521.791;Inherit;False;1194;AlphaMask;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;830;-2960.85,-1250.992;Inherit;False;Property;_MetallicMask;MetallicMask;46;0;Create;True;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;881;-7452.899,-2092.046;Inherit;False;Property;_WetnessPower2;WetnessPower2;30;0;Create;True;0;0;True;0;False;0.25;0.25;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.DotProductOpNode;1291;702.7375,-3056.425;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SinOpNode;1294;530.8167,-3358.074;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;1293;675.2986,-3254.244;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.CrossProductOpNode;1292;432.4334,-3620.411;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SamplerNode;343;-2966.85,-1567.679;Inherit;True;Property;_DetailMainTex1;DetailMainTex1;1;0;Create;True;0;0;True;0;False;-1;None;None;True;0;False;gray;Auto;False;Instance;1181;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1250;1399.953,4796.357;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;1257;1659.711,4490.423;Inherit;False;detail1;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;1267;-2889.163,-5675.84;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;1;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;1197;-2625.081,-5820.16;Inherit;False;Property;_AlphaMask;AlphaMask;61;0;Create;True;0;0;True;1;Header (Alpha masking Occlusion_A Mask (Optional));False;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;1247;-2668.826,-5356.523;Inherit;False;1257;detail1;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1297;859.2715,-3680.595;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1296;941.3577,-3219.562;Inherit;False;3;3;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1295;863.7495,-3350.232;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1269;-2662.288,-5600.947;Inherit;False;Property;_DetailAlpha1;DetailAlpha1;66;0;Create;True;0;0;False;0;False;1;1;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;1258;1658.92,4791.603;Inherit;False;detail2;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;1196;-2322.355,-5669.235;Inherit;False;3;0;FLOAT;1;False;1;FLOAT;1;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;1261;-2425.044,-5357.823;Inherit;False;1258;detail2;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;1251;1709.889,4621.728;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1262;-2663.643,-5499.822;Inherit;False;Property;_DetailAlpha2;DetailAlpha2;64;0;Create;True;0;0;False;0;False;1;1;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1299;1102.65,-2878.966;Inherit;False;Property;_IriContrast;IriContrast;65;0;Create;True;0;0;True;0;False;0.5840003;0.5;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;796;-2691.792,1809.167;Inherit;False;Property;_DetailOcclusionContrast;DetailOcclusionContrast;43;0;Create;True;0;0;False;0;False;0;1;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;1298;1207.98,-3677.108;Inherit;True;3;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;1301;1562.93,-3551.76;Inherit;True;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0.5,0.5,0.5;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;1302;1305.111,-3229.917;Inherit;False;Property;_IriBrightness;IriBrightness;63;0;Create;True;0;0;True;0;False;0.6471324;0.5;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1300;1475.357,-3031.146;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;2;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;798;-2718.878,2388.694;Inherit;False;Property;_DetailOcclusionContrast2;DetailOcclusionContrast2;42;0;Create;True;0;0;False;0;False;0;1;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;1233;1994.297,4636.211;Inherit;True;DetailGloss;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;1259;-2128.913,-5669.523;Inherit;False;3;0;FLOAT;1;False;1;FLOAT;1;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;829;-2977.513,-2267.672;Inherit;False;Property;_Roughness;Roughness;45;0;Create;True;0;0;False;2;Header (Metallic Roughness (Optional));;False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;442;-2669.698,1707.236;Inherit;False;366;DetailMask1;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;54;-2701.678,1613.969;Inherit;False;Property;_DetailOcclusionScale;DetailOcclusionScale;40;0;Create;True;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1304;1838.244,-3546.46;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1303;1742.644,-3223.381;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;2;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;406;-1885.302,-5429.515;Inherit;False;405;TearingsMask;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;1234;-2937.428,-2133.56;Inherit;False;1233;DetailGloss;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;1056;-2101.229,-3129.114;Inherit;False;Property;_WeatheringAlbedo;WeatheringAlbedo;16;0;Create;True;0;0;True;0;False;0.6,0.65,0.65,0;0.6,0.65,0.65,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;55;-2719.32,2172.962;Inherit;False;Property;_DetailOcclusionScale2;DetailOcclusionScale2;41;0;Create;True;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;43;-1935.218,-5225.622;Inherit;False;Property;_AlphaEx;AlphaEx;27;0;Create;True;0;0;True;1;Header (Cloth Tearings);False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;1187;-1912.662,-5558.669;Inherit;False;922;WeatheringAlpha2;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;604;-2848.693,200.3948;Inherit;False;817;ColorTex;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;533;-2967.873,-1882.683;Inherit;False;Property;_Roughness4;Roughness4;48;0;Create;True;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;835;-7455.587,-2190.146;Inherit;False;Property;_WetnessPower;WetnessPower;29;0;Create;True;0;0;True;0;False;0.8;0.8;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.TFHCGrayscale;782;-2125.773,1408.219;Inherit;False;0;1;0;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;1271;-1918.69,-5818.896;Inherit;False;Property;_DetailAlpha;DetailAlpha;72;0;Create;True;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.WireNode;710;-1416.749,-5393.885;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;189;-2978.64,-1996.283;Inherit;False;Property;_Glossiness4;Glossiness4;47;0;Create;True;0;0;False;2;Header (Color 4 Settings (Optional));;False;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1193;-1595.212,-5692.444;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;611;-2226.075,-342.1872;Inherit;False;588;EC3;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.StaticSwitch;1218;-2398.037,-2315.499;Inherit;False;Property;_DetailGloss;DetailGloss;44;0;Create;True;0;0;True;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;705;-1459.895,-5221.496;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;1306;2025.869,-3545.968;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0.5,0.5,0.5;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;1305;1904.643,-3220.381;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;1308;2200.244,-3547.42;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.Vector3Node;1307;2130.36,-3237.094;Inherit;False;Constant;_Vector3;Vector 0;0;0;Create;True;0;0;False;0;False;0.39,0.59,0.11;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;1309;1796.266,-2879.756;Inherit;False;Property;_IriSaturation;IriSaturation;62;0;Create;True;0;0;True;0;False;0.5688156;0.5;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;1186;-1407.045,-5812.785;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;1;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.WireNode;709;-1367.84,-5411.266;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.WireNode;732;-1023.448,-5193.236;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CeilOpNode;1214;-3707.219,-5131.481;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ClipNode;708;-1168.104,-5707.262;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.WireNode;731;-988.6182,-5223.529;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.WireNode;1275;-924.8647,-5084.396;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1310;2210.566,-2967.085;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;2;False;1;FLOAT;0
Node;AmplifyShaderEditor.DotProductOpNode;1311;2413.43,-3423.825;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;1312;2719.157,-3069.804;Inherit;False;636;MetallicFinal;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;1313;2669.305,-3820.119;Inherit;False;501;DiffuseMix;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1131;-729.9335,-2113.28;Inherit;False;Property;_WeatheringGloss;WeatheringGloss;57;0;Create;True;0;0;True;0;False;0.8;0.8;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;701;-896.1039,-5803.262;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;1;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;1314;2648.527,-3567.272;Inherit;True;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.WireNode;1274;-850.9313,-5103.852;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1272;-631.3746,-5801.803;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;1315;3073.291,-3589.561;Inherit;True;3;0;FLOAT3;1,1,1;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;487;-406.0986,-5805.511;Inherit;True;AlphaMix;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;1316;3344.679,-3595.834;Inherit;False;Specular;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SamplerNode;23;-4400.113,895.7682;Inherit;True;Property;_OcclusionMap;OcclusionMap;9;1;[NoScaleOffset];Create;True;0;0;True;1;Header(Packed (R_AO G_none B_Tearings));False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;244;-4398.097,1130.591;Inherit;True;Property;_BumpMap;BumpMap;3;1;[NoScaleOffset];Create;True;0;0;True;0;False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;2;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;554;668.1394,-1507.099;Inherit;False;553;OcclusionMix;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;113;-4064.719,1131.531;Inherit;True;Property;_ColorMask;ColorMask;2;1;[NoScaleOffset];Create;True;0;0;True;1;Header (Optional (Required for Color 4));False;-1;None;None;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;1;-4054.793,1587.868;Inherit;True;Property;_MainTex;MainTex;0;1;[NoScaleOffset];Create;True;0;0;True;2;Header(Render Texture (leave empty));;False;-1;None;d585f7d222255e44ab417bdd1c4d1ddc;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;635;666.329,-1673.431;Inherit;False;1316;Specular;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.OneMinusNode;1276;-2553.936,-2165.378;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;1206.381,-1799.783;Float;False;True;-1;7;ASEMaterialInspector;0;0;StandardSpecular;Iridescent/Clothes True Transparent;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;False;Off;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Transparent;0;True;True;0;False;Transparent;2600;Transparent;All;6;d3d9;d3d11_9x;d3d11;glcore;gles;gles3;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;0;32;1;2;True;1;True;2;5;False;-1;10;False;-1;1;5;False;-1;8;False;-1;6;False;-1;6;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;-1;-1;0;True;660;0;0;0;False;0.1;False;-1;0;False;-1;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;1286;1;1284;0
WireConnection;1288;0;1287;0
WireConnection;1290;0;1286;0
WireConnection;1289;0;1285;0
WireConnection;885;0;884;0
WireConnection;1228;0;1226;0
WireConnection;1210;1;427;0
WireConnection;1210;0;1212;0
WireConnection;1249;0;1224;0
WireConnection;1249;1;1225;0
...
WireConnection;1291;0;1289;0
WireConnection;1291;1;1290;0
WireConnection;1294;0;1287;0
WireConnection;1293;0;1288;0
...
WireConnection;1250;0;1228;0
WireConnection;1250;1;1230;0
...
WireConnection;1257;0;1249;0
WireConnection;1267;0;1210;0
WireConnection;1267;1;1239;0
WireConnection;1267;2;1195;0
WireConnection;891;0;880;0
WireConnection;817;0;658;0
WireConnection;1197;1;1210;0
WireConnection;1197;0;1267;0
WireConnection;180;0;179;0
WireConnection;807;0;645;0
WireConnection;807;1;1243;0
WireConnection;1297;0;1290;0
WireConnection;1297;1;1288;0
WireConnection;1296;0;1282;0
WireConnection;1296;1;1291;0
WireConnection;1296;2;1293;0
WireConnection;375;0;1183;1
WireConnection;1295;0;1292;0
...
WireConnection;1196;1;1269;0
WireConnection;1196;2;1247;0
...
WireConnection;1251;1;1250;0
WireConnection;780;1;787;0
WireConnection;1298;0;1297;0
WireConnection;1298;1;1295;0
WireConnection;1298;2;1296;0
...
WireConnection;1233;0;1251;0
WireConnection;1259;0;1196;0
WireConnection;1259;1;1262;0
WireConnection;1259;2;1261;0
...
WireConnection;1271;1;1197;0
WireConnection;1271;0;1259;0
...
WireConnection;1193;0;1271;0
WireConnection;1193;1;1187;0
WireConnection;1218;1;828;0
WireConnection;1218;0;1234;0
...
WireConnection;1214;0;427;0
WireConnection;564;1;573;0
WireConnection;564;0;611;0
WireConnection;815;0;1218;0
...
WireConnection;1314;0;1311;0
WireConnection;1314;1;1308;0
WireConnection;1314;2;1310;0
...
WireConnection;1272;0;701;0
WireConnection;1272;1;1274;0
...
ASEEND*/
//CHKSM=18DD52C87294AE78F1F1765635E44333C3CCE628