...
Shader "Hanmen/Next-Gen Body"
{
	Properties
	{
		...
		_MakeUpGlossPower("MakeUpGlossPower", Range( 1 , 6)) = 1.5
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float2 uv_MainTex620 = i.uv_texcoord;
			float4 tex2DNode620 = tex2D( _MainTex, uv_MainTex620 );
			float2 uv_DetailMainTex615 = i.uv_texcoord;
			float3 lerpResult619 = lerp( ( exgloss297 == 0.0 ? (_SpecColor).rgb : (color530).rgb ) , ( (tex2DNode620).rgb * float3( 0.25,0.25,0.25 ) ) , ( tex2D( _DetailMainTex, uv_DetailMainTex615 ).r * tex2DNode620.a ));
			...
			float3 lerpResult496 = lerp( (lerpResult619).xyz , nailglosscolor504 , nails426);
			...
			float2 uv_DetailMainTex610 = i.uv_texcoord;
			float2 uv_MainTex85 = i.uv_texcoord;
			float4 tex2DNode85 = tex2D( _MainTex, uv_MainTex85 );
			float MainTexAlpha623 = tex2DNode85.a;
			float lerpResult613 = lerp( ( ( lerpResult583 - ( 1.0 - tex2D( _OcclusionMap, uv_OcclusionMap270 ).r ) ) + wetness_alpha468 ) , _MakeUpGlossPower , ( tex2D( _DetailMainTex, uv_DetailMainTex610 ).b * MainTexAlpha623 ));
			float lerpResult425 = lerp( lerpResult613 , _NailGloss , nails426);
			...
			float Smoothness307 = ( ( exgloss297 == 0.0 ? _Gloss : 1.0 ) * GlossMapsMix295 );
		...
		void surf( Input i , inout SurfaceOutputCustomLightingCustom o )
		{
			...
			float3 lerpResult70 = lerp( (tex2DNode85).rgb , nails_color418 , nails_alpha417);
...
/*ASEBEGIN
Version=18707
101;1;1782;1010;373.7317;1928.706;1.353331;True;False
...
Node;AmplifyShaderEditor.ColorNode;64;-4669.524,-2282.69;Inherit;False;Property;_Color2;Color2 (Nipples);14;0;Create;False;0;0;True;0;False;1,0.5424528,0.5424528,0;0.6886792,0.1916601,0.1916601,0.7607843;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.CommentaryNode;268;437.2572,-1901.623;Inherit;False;2709.265;1984.132;Comment;28;275;427;425;293;292;294;295;597;291;437;288;598;282;595;276;583;270;273;589;596;428;610;611;613;614;616;617;624;Glossiness Mix;0.4575472,0.9384768,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;48;576.4445,-5114.65;Inherit;False;814.7977;591.2971;MAIN;6;72;412;68;409;85;623;MainTex;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;428;509.1364,-998.5284;Inherit;False;1041.669;334.7586;Comment;5;269;297;439;468;538;Wetness to Gloss;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;269;541.8774,-760.6404;Inherit;False;Property;_ExGloss;ExGloss;35;0;Create;True;0;0;True;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;297;874.8116,-761.2434;Inherit;False;exgloss;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;538;530.1058,-957.6763;Inherit;True;Property;_TextureSample29;Texture Sample 29;10;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;82;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;439;1130.677,-925.9093;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;468;1319.622,-930.3873;Inherit;False;wetness_alpha;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;606;890.5049,-3062.882;Inherit;True;Property;_BumpMap3;BumpMap3;62;0;Create;True;0;0;True;0;False;-1;None;None;True;0;False;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.CommentaryNode;596;502.8378,-559.8901;Inherit;False;1272.095;559.0971;Comment;7;289;286;280;278;279;271;272;Nipples Gloss;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;623;1143.157,-4939.041;Inherit;False;MainTexAlpha;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;272;552.8378,-137.639;Inherit;False;27;NipUV1;1;0;OBJECT;;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.VertexColorNode;271;839.8521,-202.7931;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.OneMinusNode;278;1192.22,-158.1097;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;279;764.9041,-416.0392;Inherit;True;Property;_TextureSample17;Texture Sample 17;8;0;Create;True;0;0;False;0;False;-1;None;None;True;1;False;white;Auto;False;Instance;41;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;232;-2490.05,-320.3268;Inherit;False;Property;_alpha_d;alpha_d;59;1;[HideInInspector];Create;True;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;624;562.7731,-1234.447;Inherit;False;623;MainTexAlpha;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;227;-2492.703,-485.3287;Inherit;False;Property;_alpha_b;alpha_b;60;1;[HideInInspector];Create;True;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;614;537.0519,-1135.328;Inherit;False;Property;_MakeUpGlossPower;MakeUpGlossPower;63;0;Create;True;0;0;True;0;False;1.5;4;1;6;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;611;880.9046,-1327.568;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;286;559.7885,-509.89;Inherit;False;Property;_NipGloss;NipGloss;39;0;Create;True;0;0;True;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;595;1581.114,-1001.16;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;280;1432.875,-340.2778;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;289;1610.464,-505.6116;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.WireNode;617;1354.711,-1330.257;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;616;1384.655,-1216.094;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.WireNode;598;1932.043,-484.0514;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;613;1928.647,-1731.932;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;275;1980.492,-1537.778;Inherit;False;Property;_NailGloss;NailGloss;40;0;Create;True;0;0;True;0;False;0;0.164;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;427;2057.668,-1440.547;Inherit;False;426;nails;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.WireNode;288;2004.497,-305.4879;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.WireNode;597;1981.305,-527.6532;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;291;2044.192,-343.547;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;425;2290.142,-1732.173;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;1;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;298;486.157,204.1439;Inherit;False;2382.45;1318.708;Comment;22;307;306;303;496;505;495;305;301;536;300;527;531;529;532;530;299;615;618;620;621;622;619;Specular;1,1,1,1;0;0
Node;AmplifyShaderEditor.ColorNode;530;526.9754,287.1756;Inherit;False;Constant;_WetColor;WetColor;54;0;Create;True;0;0;False;0;False;0.2,0.2,0.2,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;299;526.6465,471.1318;Inherit;False;Property;_SpecColor;SpecColor;17;0;Fetch;False;0;0;True;1;Header (Specularity);False;0.2,0.2,0.2,0;0.1999983,0.1999983,0.1999983,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;620;520.0083,852.6351;Inherit;True;Property;_TextureSample23;Texture Sample 23;3;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;42;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;292;2488.587,-1528.287;Inherit;False;46;hair;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;293;2505.709,-1730.106;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ComponentMaskNode;531;810.5668,287.6426;Inherit;False;True;True;True;False;1;0;COLOR;0,0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.LerpOp;294;2700.189,-1730.68;Inherit;False;3;0;FLOAT;1;False;1;FLOAT;0.5;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;311;-2122.116,3071.517;Inherit;False;Property;_TransmissionColor;TransmissionColor;47;0;Fetch;False;0;0;True;0;False;0.2,0.2,0.2,0;0.5,0.2999992,0.1999992,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;498;-4695.441,-3012.27;Inherit;False;Property;_NailSpecularColor;NailSpecularColor;18;0;Create;True;0;0;True;0;False;0.5,0.5,0.5,0;0.3018864,0.3018864,0.3018864,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.GetLocalVarNode;529;532.8208,1059.515;Inherit;False;297;exgloss;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;615;522.364,653.7549;Inherit;True;Property;_TextureSample22;Texture Sample 22;6;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;372;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ComponentMaskNode;621;858.5851,852.6349;Inherit;False;True;True;True;False;1;0;COLOR;0,0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.WireNode;246;-995.931,-1255.053;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ComponentMaskNode;532;809.5837,469.5117;Inherit;False;True;True;True;False;1;0;COLOR;0,0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;618;945.4376,679.4271;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.Compare;527;1088.254,323.8599;Inherit;False;0;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;622;1124.216,859.5173;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0.25,0.25,0.25;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;300;535.0359,1143.223;Inherit;False;Property;_Gloss;Gloss;36;0;Create;True;0;0;True;0;False;1;0.9401839;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;619;1620.632,330.0106;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;495;2147.322,590.2895;Inherit;False;426;nails;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;505;2108.228,479.0668;Inherit;False;504;nailglosscolor;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.ComponentMaskNode;305;2120.423,324.2347;Inherit;False;True;True;True;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleMaxOpNode;568;-1088.73,380.4437;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.Compare;536;1100.959,1092.943;Inherit;False;0;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;301;531.6555,1227.085;Inherit;True;295;GlossMapsMix;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;496;2427.513,368.6936;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;303;2081.094,1204.014;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;307;2651.101,1198.882;Inherit;True;Smoothness;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;306;2638.574,365.199;Inherit;True;Specular;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;386;-3347.47,2951.443;Inherit;True;Property;_LightingTexBlurred;LightingTexBlurred;61;2;[HideInInspector];[NoScaleOffset];Fetch;True;0;0;True;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
WireConnection;611;0;610;3
WireConnection;611;1;624;0
...
WireConnection;618;0;615;1
WireConnection;618;1;620;4
...
WireConnection;619;0;527;0
WireConnection;619;1;622;0
WireConnection;619;2;618;0
...
ASEEND*/
//CHKSM=E89405008B6F627418346F95BCF6E7953941029A