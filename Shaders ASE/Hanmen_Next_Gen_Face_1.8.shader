...
Shader "Hanmen/Next-Gen Face"
{
	Properties
	{
		...
		_MakeUpGlossPower("MakeUpGlossPower", Range( 1 , 6)) = 1.8
	...
	SubShader
	{
		...
		uniform float _MakeUpGlossPower;
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float2 uv_MainTex780 = i.uv_texcoord;
			float2 uv_DetailMainTex383 = i.uv_texcoord;
			float4 tex2DNode383 = tex2D( _DetailMainTex, uv_DetailMainTex383 );
			float3 lerpResult782 = lerp( (( exgloss297 == 0.0 ? (_SpecColor).rgb : (color544).rgb )).xyz , ( (tex2D( _MainTex, uv_MainTex780 )).rgb * float3( 0.25,0.25,0.25 ) ) , ( tex2DNode383.r * tex2DNode383.a ));
			...
			float3 lerpResult653 = lerp( lerpResult782 , (_WeatheringSpecular).rgb , WeatheringAlpha611);
			...
			float4 tex2DNode85 = tex2D( _MainTex, uv_MainTex85 );
			float MainTexAlpha792 = tex2DNode85.a;
			float lerpResult392 = lerp( ( lerpResult294 + wetness_alpha468 ) , _MakeUpGlossPower , ( tex2DNode383.b * MainTexAlpha792 ));
			float GlossMapsMix295 = lerpResult392;
			float lerpResult659 = lerp( ( ( exgloss297 == 0.0 ? _Gloss : 1.0 ) * GlossMapsMix295 ) , _WeatheringGloss , WeatheringAlpha611);
			float Smoothness542 = lerpResult659;
		...
		void surf( Input i , inout SurfaceOutputCustomLightingCustom o )
		{
			...
			float4 tex2DNode86 = tex2D( _Texture3, EyebrowsUV25 );
			float hairs_alpha407 = ( tex2DNode86.b * ( _Color3.a * 1.5 ) * i.vertexColor.g );
			float3 lerpResult76 = lerp( (tex2DNode85).rgb , hairs_color419 , hairs_alpha407);
...
/*ASEBEGIN
Version=18707
101;7;1782;1004;-1230.181;1313.85;1;True;False
...
Node;AmplifyShaderEditor.Vector4Node;732;-4821.84,-1195.093;Inherit;False;Property;_Texture3UV;Texture3UV;57;0;Create;True;0;0;True;0;False;0,0,0,0;0.046,0.1078,1,1.1;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;9;-4789.398,-696.9695;Inherit;False;Property;_Texture3Rotator;Texture3Rotator;28;0;Create;True;0;0;True;0;False;0;0;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;560;-4769.003,-1932.216;Inherit;False;Property;_WeatheringUV;WeatheringUV;19;0;Create;True;0;0;True;0;False;0,0,0,0;1,0.9,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector2Node;753;-2709.09,-4149.645;Inherit;False;Property;_DetailUV;DetailUV;15;0;Create;True;0;0;True;0;False;24,24;24,24;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;589;-4759.734,-2974.541;Inherit;False;Property;_WeatheringRange6;WeatheringRange6;54;0;Create;True;0;0;True;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;588;-4764.436,-3070.358;Inherit;False;Property;_WeatheringAll;WeatheringAll;53;0;Create;True;0;0;True;1;Header (Juice Texture);False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;101;-2748.378,-4016.672;Inherit;False;Property;_DetailNormalMapScale;DetailNormalMapScale;31;0;Fetch;True;0;0;True;0;False;0.25;0.5087057;0;9;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;47;-4790.764,-3985.894;Inherit;False;Property;_Color3;Color3 (Hairs);16;0;Create;False;0;0;True;0;False;1,1,1,0;0.32075,0.1800417,0.1800417,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;686;-4773.648,-4756.793;Inherit;False;Property;_Blushcolor;Blushcolor;25;0;Create;True;0;0;True;0;False;0.6320754,0.2295745,0.2295745,0.4705882;0.6320754,0.2295718,0.2295718,0.4705882;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;473;-4760.476,-4873.275;Inherit;False;Property;_Texture4Scale;Texture4Scale;38;0;Create;True;0;0;False;1;Header (Blush);False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;268;623.1769,-1608.037;Inherit;False;2620.078;1131.702;Comment;19;295;392;383;437;470;294;292;282;276;756;270;273;755;428;761;777;790;791;793;Glossiness Mix;0.4575472,0.9384768,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;48;-2421.114,-1183.633;Inherit;False;725.8331;586.7349;MAIN;6;72;412;409;68;85;792;MainTex;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;428;692.1795,-1035.732;Inherit;False;1059.144;366.2868;Comment;5;468;439;297;269;730;Wetness to Gloss;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;269;744.8542,-777.1437;Inherit;False;Property;_ExGloss;ExGloss;32;0;Create;True;0;0;True;1;Header (Wetness);False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;730;750.5645,-990.0461;Inherit;True;Property;_TextureSample24;Texture Sample 24;8;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;82;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;297;1024.356,-776.1594;Inherit;False;exgloss;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;674;-1219.81,-664.9891;Inherit;False;Property;_WeatheringAlbedo;WeatheringAlbedo;18;0;Create;True;0;0;True;0;False;0,0,0,0;0.6,0.65,0.65,0.6509804;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;439;1288.571,-791.1339;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;468;1483.518,-783.8612;Inherit;False;wetness_alpha;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;696;-1157.666,-4850.86;Inherit;False;Property;_WeatheringBumpPower;WeatheringBumpPower;56;0;Create;True;0;0;True;0;False;0;7.53;0;9;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;108;706.9673,-3511.255;Half;False;Property;_BumpScale2;BumpScale2;30;0;Fetch;True;0;0;True;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;110;684.436,-3843.327;Inherit;False;Property;_BumpScale;BumpScale;29;0;Fetch;True;0;0;True;0;False;1;0.5063668;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;755;680.3913,-1310.857;Inherit;False;754;DetailUV;1;0;OBJECT;;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SamplerNode;273;926.2678,-1335.542;Inherit;True;Property;_TextureSample14;Texture Sample 14;6;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;137;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;270;914.3142,-1541.013;Inherit;True;Property;_TextureSample13;Texture Sample 6;9;0;Create;False;0;0;True;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;222;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;333;-2794.39,809.8641;Inherit;False;Property;_AlbedoOpacity;AlbedoOpacity;40;0;Fetch;True;0;0;True;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;756;1273.68,-1261.922;Inherit;False;3;0;FLOAT;0.85;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;276;1272.902,-1513.864;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;761;1738.704,-1343.073;Inherit;False;Property;_EyebrowGloss;EyebrowGloss;37;0;Create;True;0;0;True;0;False;0.5;0.5038513;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;334;-2804.646,1006.184;Inherit;False;Property;_SubsurfaceAlbedoSaturation;SubsurfaceAlbedoSaturation;42;0;Fetch;True;0;0;True;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;792;-2023.585,-998.2585;Inherit;False;MainTexAlpha;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;282;1487.541,-1437.308;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;292;1790.143,-1246.99;Inherit;False;46;hair;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;470;2205.805,-1249.532;Inherit;False;468;wetness_alpha;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;530;838.3213,-428.6245;Inherit;False;2439.247;1325.919;Comment;27;542;659;661;537;616;533;550;531;543;672;655;673;541;653;538;548;546;547;545;544;299;780;781;782;783;786;787;Specular;1,1,1,1;0;0
Node;AmplifyShaderEditor.SamplerNode;383;1805.719,-865.8679;Inherit;True;Property;_TextureSample20;Texture Sample 20;5;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;372;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.LerpOp;294;2150.102,-1438.802;Inherit;False;3;0;FLOAT;1;False;1;FLOAT;0.6;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;793;1836.95,-636.6998;Inherit;False;792;MainTexAlpha;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;299;879.7909,-162.907;Inherit;False;Property;_SpecColor;SpecColor;20;0;Fetch;False;0;0;True;1;Header (Specularity);False;0.2,0.2,0.2,0;0.1999994,0.1999994,0.1999994,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.GetLocalVarNode;543;885.9286,403.4075;Inherit;False;297;exgloss;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;314;-2760.374,1677.142;Inherit;False;Property;_TransOcclusion;TransOcclusion;47;0;Fetch;True;0;0;True;0;False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.NormalizeNode;706;1700.005,1128.186;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;777;1821.582,-968.7171;Inherit;False;Property;_MakeUpGlossPower;MakeUpGlossPower;36;0;Create;True;0;0;True;0;False;1.8;4;1;6;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;544;871.1579,-355.4818;Inherit;False;Constant;_WetColor;WetColor;54;0;Create;True;0;0;False;0;False;0.2,0.2,0.2,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;311;-2736.383,1778.368;Inherit;False;Property;_TransmissionColor;TransmissionColor;22;0;Fetch;False;0;0;True;0;False;0.2,0.2,0.2,0;0.5,0.2999954,0.1999953,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;721;1098.357,1636.086;Inherit;False;Property;_SecondaryGloss;SecondaryGloss;35;0;Create;True;0;0;True;0;False;0;0.319;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;313;-2721.897,1964.709;Inherit;True;376;NormalMix;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;790;2217.294,-967.842;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;437;2449.32,-1438.172;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ComponentMaskNode;546;1108.63,-164.9293;Inherit;False;True;True;True;False;1;0;COLOR;0,0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.LerpOp;392;2698.473,-1436.456;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;1;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ComponentMaskNode;545;1103.978,-355.3036;Inherit;False;True;True;True;False;1;0;COLOR;0,0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;727;1390.122,1886.66;Inherit;False;Property;_SecondaryGlossPower;SecondaryGlossPower;34;0;Create;True;0;0;True;0;False;0;0.214;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.WireNode;547;1283.315,-46.43081;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;672;874.978,208.551;Inherit;False;Property;_WeatheringSpecular;WeatheringSpecular;17;0;Create;True;0;0;True;0;False;0,0,0,0;0.349997,0.349997,0.349997,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;780;874.16,5.616653;Inherit;True;Property;_TextureSample9;Texture Sample 9;2;0;Create;True;0;0;False;0;False;42;None;None;True;0;False;white;Auto;False;Instance;42;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ComponentMaskNode;673;1191.211,212.7249;Inherit;False;True;True;True;False;1;0;COLOR;0,0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;531;884.1891,510.9695;Inherit;False;Property;_Gloss;Gloss;33;0;Create;True;0;0;True;0;False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;323;-825.8114,540.0941;Inherit;True;354;albedo_final;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.ComponentMaskNode;781;1188.605,4.183105;Inherit;False;True;True;True;False;1;0;COLOR;0,0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;295;2990.864,-1441.339;Inherit;True;GlossMapsMix;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;325;-2131.92,1980.824;Inherit;False;Property;_TransBase;TransBase;43;0;Fetch;True;0;0;True;1;Header (Transmission);False;1;1;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Compare;548;1427.229,-308.3731;Inherit;False;0;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.Compare;550;1500.511,396.4563;Inherit;False;0;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;783;1468.047,8.840822;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0.25,0.25,0.25;False;1;FLOAT3;0
Node;AmplifyShaderEditor.WireNode;787;2048.255,244.0177;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.ComponentMaskNode;538;1687.448,-310.2493;Inherit;False;True;True;True;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;791;2215.06,-690.7753;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;533;891.9765,621.5145;Inherit;True;295;GlossMapsMix;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;661;1917.957,709.8078;Inherit;False;Property;_WeatheringGloss;WeatheringGloss;55;0;Create;True;0;0;True;0;False;0.8;0.8;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;782;2265.499,-305.794;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;655;2470.328,80.33585;Inherit;False;611;WeatheringAlpha;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;537;1702.581,607.8491;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;218;615.8171,-2429.822;Inherit;False;Property;_OcclusionStrength;OcclusionStrength;39;0;Fetch;True;0;0;True;2;Header (Ambient Occlusion);;False;0;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;786;2125.539,220.6528;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;616;1958.46,798.6884;Inherit;False;611;WeatheringAlpha;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;653;2815.472,-308.0209;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0.35,0.35,0.35;False;2;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.LerpOp;659;2306.893,605.9399;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0.83;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;541;3054.047,-314.1777;Inherit;True;Specularity1;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;542;3046.33,599.7712;Inherit;True;Smoothness;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;359;-368.3495,1977.078;Inherit;False;Property;SUBSURFACE_PARALLAX;SUBSURFACE_PARALLAX;50;1;[HideInInspector];Fetch;False;0;0;True;1;Toggle(SUBSURFACE_PARALLAX);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;221;646.7312,-2326.063;Inherit;False;Property;_OcclusionColor;OcclusionColor;21;0;Fetch;True;0;0;True;0;False;0,0,0,0;0.2547113,0.09491246,0.09491246,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;368;-1530.033,1740.305;Inherit;False;Property;_TransDynamic;TransDynamic;44;0;Fetch;True;0;0;True;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;367;-373.8517,1797.437;Inherit;False;Property;_CavityStrength;CavityStrength;49;1;[HideInInspector];Fetch;True;0;0;True;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;235;-278.0352,-168.5904;Inherit;False;Property;_Cutoff;Cutoff;26;0;Create;True;0;0;True;0;False;0.5;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;370;-1528.563,1871.76;Inherit;False;Property;_TransRange;TransRange;45;0;Fetch;True;0;0;True;0;False;0.5;0.5;0;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;362;-69.05493,1794.531;Inherit;False;Property;_AlbedoTile;AlbedoTile;27;0;Fetch;True;0;0;True;0;False;1;1;1;20;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;757;-1193.97,924.0066;Inherit;False;Property;_VeinsOpacity;VeinsOpacity;46;0;Fetch;True;0;0;True;0;False;1;0.992;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;360;-955.7218,1957.117;Inherit;False;Property;_ProfileColor;Profile Color;24;0;Fetch;True;0;0;True;1;Header (Separate Profile);False;0,0,0,0;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;358;-1191.724,840.744;Inherit;False;Property;_SubsurfaceAlbedoOpacity;SubsurfaceAlbedoOpacity;41;0;Fetch;True;0;0;True;0;False;0;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;357;-367.5846,2072.381;Inherit;False;Property;_SubSurfaceParallax;SubSurface Parallax;51;1;[HideInInspector];Fetch;True;0;0;True;0;False;-0.000363;-0.000363;-0.002;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;369;-1529.958,1999.906;Inherit;False;Property;_TransShadows;TransShadows;48;0;Fetch;True;0;0;True;0;False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;366;-370.6236,1883.734;Inherit;False;Property;_FresnelIntensity;FresnelIntensity;52;1;[HideInInspector];Fetch;True;0;0;True;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;758;-1464.27,848.0796;Inherit;False;Property;_VeinsColor;VeinsColor;23;0;Fetch;True;0;0;True;0;False;0,0,0,0;0.3021085,0.661216,0.6886792,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;790;0;383;3
WireConnection;790;1;793;0
...
WireConnection;392;1;777;0
WireConnection;392;2;790;0
...
WireConnection;791;0;383;1
WireConnection;791;1;383;4
...
WireConnection;782;0;538;0
WireConnection;782;1;783;0
WireConnection;782;2;791;0
...
WireConnection;653;0;782;0
WireConnection;653;1;786;0
...
ASEEND*/
//CHKSM=91F106D703CBBED01E0C28C22E29581DA0ABB55A